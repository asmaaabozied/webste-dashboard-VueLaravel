...
/* harmony default export */ var Devicevue_type_script_lang_js_ = ({
  ...
  methods: {
    save: function save() {
      ...
      var url = "/api/admin-panel/devices/createUpdate";
      var data = {
    ...
    load: function load() {
      ...
      axios_default.a.get("/api/admin-panel/devices/getData/".concat(this.id)).then(function (res) {
        console.log(res);
        _this2.name_ar = res.data.resource.name_ar;
        _this2.name_en = res.data.resource.name_en;
      })["catch"](function (err) {
        console.warn(err);
      });
    },
