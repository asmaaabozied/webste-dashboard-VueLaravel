                ...
                _c(
                  ...
                  _vm._l(_vm.itemsFiltered, function(item, i) {
                    return _c("tr", { key: i }, [
                      ...
                      _vm._v(" "),
                      _c("td", { staticClass: "text-center" }, [
                        _vm._v(_vm._s(_vm.$getOrderStatus(item.status).label))
                      ]),
                      _vm._v(" "),
                      _c("td", { staticClass: "text-center" }, [
                        _vm._v(
...
installComponents_default()(component, {VCol: VGrid["VCol"],VRow: VGrid["VRow"],VSelect: VSelect["VSelect"],VSimpleTable: VDataTable["VSimpleTable"]})
