  ...
  methods: {
    getTransactionType: function getTransactionType(item) {
      if (item["maintenance_order_info"] != null || item["Installment_order_id"] != null) {
        if (item.maintenance_order_info.order_info.type == 'installment_order') return this.$i18n.locale == "en" ? "installment order" : "طلب تركيب";else return this.$i18n.locale == "en" ? "maintenance order" : "طلب صيانة";
      }
