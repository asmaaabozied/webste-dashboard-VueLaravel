  ...
  methods: {
    ...
    load: function load() {
      ...
      axios.get("/api/admin-panel/getAllUser").then(function (res) {
        _this.name_ar = res.data.data.resource.name_ar;
        _this.name_en = res.data.data.resource.name_en;
        _this.code = res.data.data.resource.code;
        _this.device_id = res.data.data.resource.device_id;
        _this.manufacture_id = res.data.data.resource.manufacture_id;
      })["catch"](function (err) {
        console.warn(err);
      });
    },
    confirmDeleteItem: function confirmDeleteItem() {
      ...
      axios["delete"]("/api/admin-panel/user/delete/".concat(this.deleteItemId)).then(function (res) {
        _this2.$notify({
