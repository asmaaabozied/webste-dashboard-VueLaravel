  ...
  methods: {
    ...
    load: function load() {
      ...
      axios_default.a.get("/api/admin-panel/users/getUser/".concat(this.id)).then(function (res) {
        _this2.user_name = res.data.data.resource.user_name;
        _this2.name = res.data.data.resource.customer.name;
        _this2.phone = res.data.data.resource.customer.phone;
        _this2.type = res.data.data.resource.type;
      })["catch"](function (err) {
        console.warn(err);
      });
    },
