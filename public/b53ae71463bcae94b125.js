          ...
          _c(
            ...
            [
              _c("v-select", {
                ...
                model: {
                  value: _vm.manufactures_id,
                  callback: function($$v) {
                    _vm.manufactures_id = $$v
                  },
                  expression: "manufactures_id"
                }
              })
            ],
            1
            ...
            switch (_context.prev = _context.next) {
              ...
              case 3:
                axios.get("/api/PreventionMaintenanceOrder/".concat(_this2.id)).then(function (res) {
                  ...
                  _this2.business_type = data.business_type; // this.manufactures_id =
        ...
        return regenerator_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this3.business_name = null;
                _this3.business_phone_number = null;
                _this3.business_type = null;
                _this3.manufactures_id = null;
                _this3.location = null;
                _context2.next = 7;
                return axios.get("/api/manufacture").then(function (res) {
                  _this3.deviceTypes = res.data.data.data;
                })["catch"](function (err) {
                  console.warn(err);
                });
