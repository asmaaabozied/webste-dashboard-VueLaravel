...
/* harmony default export */ var SparePartvue_type_script_lang_js_ = (_name$metaInfo$data$v = {
  name: "devices",
...
}, _defineProperty(_name$metaInfo$data$v, "computed", {
...
}), _defineProperty(_name$metaInfo$data$v, "created", function created() {}), _name$metaInfo$data$v);
