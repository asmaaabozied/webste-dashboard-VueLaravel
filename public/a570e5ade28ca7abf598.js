...
/*!**************************************************************!*\
  !*** ./resources/js/pages/Admin/users/users.vue + 4 modules ***!
  \**************************************************************/
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vuetify-loader/lib/loader.js??ref--11-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/pages/Admin/users/users.vue?vue&type=template&id=dceea470&scoped=true&
var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    [
      _c("h3", [_vm._v(_vm._s(_vm.$t("admin.users")))]),
      _vm._v(" "),
      _c(
        "v-row",
        [
              ...
              return [
                _c("thead", [
                  _c("tr", [
                    _c("th", [_vm._v("#")]),
                    _vm._v(" "),
                    _c("th", [_vm._v(_vm._s(_vm.$t("auth.name")))]),
                    _vm._v(" "),
                    _c("th", [_vm._v(_vm._s(_vm.$t("auth.type")))]),
                    _vm._v(" "),
                    _c("th", [_vm._v(_vm._s(_vm.$t("auth.status")))]),
                    _vm._v(" "),
                    _c("th")
                  ])
                ]),
                ...
                _c(
                  ...
                  _vm._l(_vm.items, function(item, i) {
                    return _c("tr", { key: i }, [
                      ...
                      _c("td", [
                        item.status == 1
                          ? _c("span", [_vm._v(_vm._s(_vm.$t("auth.active")))])
                          : _c("span", [
                              _vm._v(_vm._s(_vm.$t("auth.Noactive")))
                            ])
                      ]),
                      _vm._v(" "),
                      _c(
                                ...
                                [
                                  ...
                                  _c(
                                    "v-list-item",
                                    {
                                      on: {
                                        click: function($event) {
                                          return _vm.chanagestatus(item.id)
                                        }
                                      }
                                    },
                                    [
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("v-card-title", { staticClass: "headline" }, [
                _vm._v(_vm._s(_vm.$t("auth.status")))
              ]),
              _vm._v(" "),
              _c("v-card-text", [_vm._v(_vm._s(_vm.$t("general.statusMsg")))]),
              _vm._v(" "),
              _c(
                "v-card-actions",
                [
                  ...
                  _c(
                    ...
                    {
                      attrs: { color: "red", text: "" },
                      on: { click: _vm.confirmStatusItem }
                    },
                    [_vm._v(_vm._s(_vm.$t("general.sure")) + "\n          ")]
                  ),
                  _vm._v(" "),
...
// CONCATENATED MODULE: ./resources/js/pages/Admin/users/users.vue?vue&type=template&id=dceea470&scoped=true&

// EXTERNAL MODULE: ./node_modules/@mdi/js/mdi.js
var mdi = __webpack_require__("./node_modules/@mdi/js/mdi.js");

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vuetify-loader/lib/loader.js??ref--11-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/pages/Admin/users/users.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var usersvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    chanagestatus: function chanagestatus(id) {
    ...
    load: function load() {
      ...
      axios.get("/api/admin-panel/getAllUser").then(function (res) {
    ...
    confirmDeleteItem: function confirmDeleteItem() {
      ...
      axios["delete"]("/api/admin-panel/users/delete/".concat(this.deleteItemId)).then(function (res) {
        _this2.$notify({
    ...
    confirmStatusItem: function confirmStatusItem() {
      var _this3 = this;

      axios["delete"]("/api/admin-panel/users/status/".concat(this.statusItemId)).then(function (res) {
        _this3.$notify({
...
// CONCATENATED MODULE: ./resources/js/pages/Admin/users/users.vue?vue&type=script&lang=js&
 /* harmony default export */ var users_usersvue_type_script_lang_js_ = (usersvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./resources/js/pages/Admin/users/users.vue
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/Admin/users/users.vue"
