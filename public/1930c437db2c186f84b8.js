...
/*! ModuleConcatenation bailout: Cannot concat with ./node_modules/vue-multiselect/dist/vue-multiselect.min.js (<- Module is not an ECMAScript module) */
...
var vue_multiselect_min = __webpack_require__("./node_modules/vue-multiselect/dist/vue-multiselect.min.js");
  ...
  methods: {
    ...
    load: function load() {
      ...
      axios_default.a.get("/api/admin-panel/services/getService/".concat(this.id)).then(function (res) {
        ...
        _this2.name_ar = data.name_ar, _this2.name_en = data.name_en, _this2.description_ar = data.description_ar, _this2.description_en = data.description_en, _this2.imagePreview = data.img;
