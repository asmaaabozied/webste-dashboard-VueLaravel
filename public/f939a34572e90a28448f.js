...
/* harmony default export */ var uservue_type_script_lang_js_ = ({
  ...
  methods: {
    save: function save() {
      ...
      var url = "/api/admin-panel/users/create-user";
      var data = {
    ...
    load: function load() {
      ...
      axios_default.a.get("/api/admin-panel/users/getUser/".concat(this.id)).then(function (res) {
        ...
        _this2.role_id = res.data.data.role_id;
        _this2.employee_id = res.data.data.employee_id;
      })["catch"](function (err) {
        console.warn(err);
      });
    },
    loadDefaults: function loadDefaults() {
      ...
      axios_default.a.get("/api/admin-panel/getALLRoles").then(function (res) {
