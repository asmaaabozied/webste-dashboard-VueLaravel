...
/* harmony default export */ var InstallmentOrdervue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      ...
      deviceTypes: [{
        text: this.$t("installment.new"),
        value: 2
      }, {
        text: this.$t("installment.old"),
        value: 1
      }],
      form: {
        device_type: "",
  ...
  methods: {
    addToItems: function addToItems() {
      ...
      this.items.push({
        ...
        brand_name: this.manufacturers.find(function (_ref) {
          var id = _ref.id;
          return id === _this.form.manufacturer;
        })["name_".concat(this.$i18n.locale)]
      });
    },
        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.t0 = _this2.step;
                _context.next = _context.t0 === 1 ? 3 : _context.t0 === 2 ? 11 : 13;
                break;

              case 3:
                if (!(_this2.disassembleLocation == null && _this2.form.type == 0 || _this2.installLocation == null)) {
                  _context.next = 8;
                  break;
                }

                _this2.$notify({
                  text: _this2.$t("general.checkMapInputs"),
                  type: "warning"
                });
        ...
        return regenerator_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                form = new FormData();
                form.append("lat", _this3.installMapCenter.lat);
                form.append("lon", _this3.installMapCenter.lng);
                _context2.next = 5;
    ...
    save: function save() {
      ...
      if (this.appointments.length > 0 && this.appointments[this.selectedAppointment] && this.appointments[this.selectedAppointment].id != undefined) {
        ...
        axios.post("/api/InstallmentOrder", this.form).then(function (_ref2) {
          var data = _ref2.data;
