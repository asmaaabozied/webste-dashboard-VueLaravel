...
export default {
  ...
  methods: {
    open(id) {
      this.$router.push({ name: "sa9-2", params: { id: id } });
    },
    addItem(id) {
      this.$router.push({ name: "sa9-2", params: { id: 0 } });
    },
    deleteItem(id) {
    ...
    confirmDeleteItem() {
      axios
        .delete(`/api/cars/${this.deleteItemId}`)
        .then((res) => {
          this.$notify({
