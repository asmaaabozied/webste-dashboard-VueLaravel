<template>
    <div>
        ...
        <v-row>
            <v-col cols="2">
<!--                <v-text-field :append-icon="icons.mdiMagnify" v-model="searchValue"></v-text-field>-->
            </v-col>
            <v-col cols="2" class="d-flex align-center">
<!--                <v-btn rounded @click="search">{{ $t('general.search') }}</v-btn>-->
            </v-col>
        ...
        <v-simple-table dense fixed-header>
            <template v-slot:default>
                ...
                <tr>
                    ...
                    <th class="text-center">{{$t('general.image')}}</th>
                    ...
                    <td class="text-center">
                        <div class="text-center">
                            <v-menu offset-y>
                                ...
                                <v-list v-if="$store.state.user.department_id == item.department_id || $roleEquals('admin') || $roleEquals('system_manager')">
